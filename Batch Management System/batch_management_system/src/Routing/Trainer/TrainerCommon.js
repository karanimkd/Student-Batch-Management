                    ...
                    <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse " style={{ backgroundColor: "black", color: "white", overflowY: "scroll" }}>
                        <div class="position-sticky mt-4 mb-4" >
                            <div class="list-group list-group-flush  mx-3  " >
                                <h6 className="text-center section_name">Trainer Profile</h6>
                                <Link to="student-profile" className="list-group-item list-group-item-action py-3 ripple " style={{ backgroundColor: "black", color: "white", borderBottom: "none" }}>
                            ...
                            <div class="list-group list-group-flush  mx-3 mt-2 " >
                                ...
                                <Link to="student-batch-schedule-attendance" class="list-group-item list-group-item-action py-3 ripple" style={{ backgroundColor: "black", color: "white", borderBottom: "none" }}
